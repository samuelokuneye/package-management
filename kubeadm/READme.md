#  **<span style="color:green"> SamOkuneye.</span>**

### **Email: samuel_okuneye@yahoo.com**
...
#this is deprecated curl -fsSLo /etc/apt/keyrings/kubernetes-archive-keyring.gpg https://packages.cloud.google.com/apt/doc/apt-key.gpg
